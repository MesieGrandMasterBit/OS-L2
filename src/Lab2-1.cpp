...
void printArguments()
{
	...
	cout << " d - Удаление файла из папки" << endl;
...
void printReadme()
{
    ...
    cout << "-Удаление файла из папки;" << endl;
    cout << "-Подсчёт общего размера указанной директории или файла; "<< endl;
    cout << "-Отображение всех файлов в указанной директории;" << endl;
    cout << "-Отображение всех процессов из фаловой системы procfs"<< endl;
    cout << "==============================================================" << endl;
